...
export const DynamicCharacterProfileSlice = createSlice({
  name: 'dynamic-resident-profile',
  initialState: {
    characterImg: '',
    characterName: '',
    characterStatus: '',
...
} = DynamicCharacterProfileSlice.actions;

export default DynamicCharacterProfileSlice.reducer;
